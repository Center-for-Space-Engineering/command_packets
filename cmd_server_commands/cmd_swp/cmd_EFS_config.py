...
class cmd_EFS_config(commandParent):
    ...
    def EFS1_config(self, args):
        ...
        self.__coms.print_message(dto, 2)
        return f"<p>ran command EFS1_config with args {str(args)}</p><p>{formatted_bytes}</p><p>{return_val}</p>"
    ...
    def EFS2_config(self, args):
        ...
        self.__coms.print_message(dto, 2)
        return f"<p>ran command EFS2_config with args {str(args)}</p><p>{formatted_bytes}</p><p>{return_val}</p>"
    ...
    def EFS3_config(self, args):
        ...
        self.__coms.print_message(dto, 2)
        return f"<p>ran command EFS3_config with args {str(args)}</p><p>{formatted_bytes}</p><p>{return_val}</p>"
