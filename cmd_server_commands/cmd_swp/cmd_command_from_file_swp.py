...
class cmd_command_from_file_swp(commandParent):
    '''
    ...
    def __init__(self, CMD, coms):
        ...
        self.__commandName = 'command_from_file_swp'
        self.__args ={
            "create_packet_swp" : self.create_packet_swp,
            "send_packet_swp" : self.send_packet_swp,
            "create_and_send_packet_swp" : self.create_and_send_packet_swp,
            "send_mode_packet_swp" : self.send_mode_packet_swp,
            "send_idle_packet_swp" : self.send_idle_packet_swp,
            "request_status_packet_swp" : self.request_status_packet_swp,
            "enter_calibration_mode_swp" : self.enter_calibration_mode_swp
        }
    ...
    def run_args(self, args):
        ...
        return message
    def create_packet_swp(self, args):
        '''
    ...
    def send_mode_packet_swp(self, args):
        '''
    ...
    def send_idle_packet_swp(self, _):
        '''
    ...
    def request_status_packet_swp(self, _):
        '''
    ...
    def enter_calibration_mode_swp(self, _):
        '''
            commands SWP2 to enter calibration mode
        '''

        packet_apid = system_constants.APID_Cal # 0x25
        byte_data = 0
        byte_data = byte_data.to_bytes(1, byteorder='big')
        ...
        # print("ran create_packets")
        dto = print_message_dto("Ran enter_calibration_mode")
        self.__coms.print_message(dto, 2)
        return f"<p>ran command enter_calibration_mode</p><p>{formatted_bytes}</p><p>{return_val}</p>"
